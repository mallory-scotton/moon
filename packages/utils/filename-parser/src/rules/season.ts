/**
 * @brief Report title regular expression
 * @description Matches common report title patterns in file names.
 */
export const REPORT_TITLE_EXP = [
...
/**
 * @brief Six digit air date match regular expression
 * @description Matches six digit air date patterns in file names.
 */
export const SIX_DIGIT_AIR_DATE_MATCH_EXP =
  /"(?<=[_.-])(?<airdate>(?<!\d)(?<airyear>[1-9]\d{1})(?<airmonth>[0-1][0-9])(?<airday>[0-3][0-9]))(?=[_.-])/i;

/**
 * @brief Rejected season regex patterns
 * @description Matches common rejected season patterns in file names.
 */
export const REJECTED_SEASON_REGEXES = [
